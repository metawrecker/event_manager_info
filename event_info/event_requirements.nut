...
this.EventRequirements <- [
    {
        ...
        UnhandledLines = ["t.hasSituation('situation.arena_tournament')", "if (town == null)"],
    },
    {
    ...
    },
    {
        ...
        TimeOfDay = "Night",
        UnhandledLines = ["if (candidates_cultist.len() != 0)"],
    },
    {
    ...
    },
    {
        ...
        UnhandledLines = ["if (candidates.len() == 0)", "if (candidates_slayer.len() != 0)"],
    },
    {
        ...
        SettlementType = "Southern",
        TimeOfDay = "Day",
        UnhandledLines = ["if (candidates_juggler.len() != 0)"],
    },
    {
    ...
    },
    {
        ...
        UnhandledLines = ["if (candidates.len() == 0)", "if (candidates_wildman.len() != 0)"],
    },
    {
